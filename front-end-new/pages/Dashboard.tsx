...
import { Copy, TickCircle, Key, Link2, Calendar, Activity, ArrowRight } from 'iconsax-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {subscriptions.length === 0 ? (
          <div className="text-center py-20">
            <div className="w-24 h-24 bg-card border border-border rounded-3xl flex items-center justify-center mx-auto mb-6">
